...
int main() {
	...
	// Pedir al usuario el nombre del archivo de entrada y salida
...
// Función para encriptar/desencriptar el texto usando XOR
void xorEncrypt(char *texto, size_t length) {
...
// Función para guardar el texto encriptado en un archivo binario
void guardarTextoEncriptado(const char *filename, char *texto, size_t length) {
...
// Función para recuperar el texto encriptado desde un archivo binario
void recuperarTextoEncriptado(const char *filename, char *buffer, size_t buffer_size) {
...
// Función para crear un archivo de entrada con el texto proporcionado por el usuario
void crearArchivoEntrada(const char *filename) {
